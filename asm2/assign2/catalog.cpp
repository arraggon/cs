...
** Author: Dongwen Yang
** Date: 10/30/2023
** Description: basketball team catalog program that will streamline access control and simplify the process of scouting for talented players
** Input: file name
** Output: 1. Search team by its name 2. Display the top scorer of each team 3. Search players by nationality 4. Sort teams by total points per game 5. Simulate a game
******************************************************/
 ...
 ***********************************************/
void cout_team(Team * teams, int i){
...
void output_team(Team * teams, int i, ofstream & output){
        ...
        for (int j = 0; j < teams[i].num_player; j++)
        {
            output << "Player Name: " << teams[i].p[j].name << " ";
            output << "Age: " << teams[i].p[j].age << " ";
            output << "Nationality: " << teams[i].p[j].nation << " ";
            output << "PPG: " << teams[i].p[j].ppg << " ";
            output << "FG: " << teams[i].p[j].fg << endl;
        }
}
